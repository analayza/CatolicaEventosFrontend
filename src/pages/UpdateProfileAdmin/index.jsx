...
import updateProfileAdmin from "../../service/UpdateProfileAdmin";
import { useEffect, useState } from "react";
import { FiUploadCloud } from "react-icons/fi";
import { useContext } from "react";
import { AuthContext } from "../../context/AuthContext";
import getAdminProfile from "../../service/GetAdminProfile";
...
export default function UpdateProfileAdmin() {
    ...
    return (
        <>
            <Menu></Menu>
            <div className="flex flex-col items-center justify-center flex-grow px-4 md:px-8 pt-3 md:pt-0">
                <div className='ml-auto hidden md:block'>
                    <Link to="/register/admin" className="whitespace-nowrap text-sm md:text-base text-blue-900 hover:underline">Cadastrar Administrador(a)</Link>
                </div>
                    ...
                    <Formik initialValues={{
                        ...
                        onSubmit={async (values, { setSubmitting }) => {
                            ...
                            try {
                                ...
                                const resul = await updateProfileAdmin(formData, token);
                                console.log(resul);
                    ...
                    >
                        {({ setFieldValue, isSubmitting }) => (
                            ...
                            <Form className='space-y-4 w-full max-w-md'>
                                ...
                                <div className='mt-4 mb-4 justify-center items-center flex md:mr-30 md:ml-35'>
                                    <ButtonComponent
                                        label="Salvar"
                                    />
                                </div>
                                <div className='w-full flex justify-end block md:hidden'>
                                    <Link to="/register/admin" className="whitespace-nowrap text-sm md:text-base text-blue-900 hover:underline">Cadastrar Administrador(a)</Link>
                                </div>
                            </Form>
                        )}
